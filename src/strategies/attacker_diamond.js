...
// Diamond pattern: northeast, southeast, southwest, northwest
// Diagonal movements: vx and vy both non-zero
// With heading=0° (north): 
// - Northeast: vx>0 (north), vy>0 (east) → vx=speed, vy=speed
// - Southeast: vx<0 (south), vy>0 (east) → vx=-speed, vy=speed
// - Southwest: vx<0 (south), vy<0 (west) → vx=-speed, vy=-speed
// - Northwest: vx>0 (north), vy<0 (west) → vx=speed, vy=-speed
